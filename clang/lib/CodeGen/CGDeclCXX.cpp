...
static void EmitDeclDestroy(CodeGenFunction &CGF, const VarDecl &D,
  ...
  // GHS uses a different interface for it's global destructor registration (__record_needed_destruction)
  // However, they are never actually called in NSMBU as it doesn't abort gracefully.
  // So, just don't.
  return; // I'm sorry if anyone relied on global dtors and has now arrived at the source of their problem :P
}
