...
void CodeGenFunction::GenerateCode(GlobalDecl GD, llvm::Function *Fn,
  ...
  llvm::BasicBlock* ThisNotNull;
  
  if (isa<CXXDestructorDecl>(FD)) {
    ThisNotNull = createBasicBlock("dtor.this.notnull");
    
    llvm::Value* This = LoadCXXThis();
    llvm::Value* IsThisNull = Builder.CreateICmpEQ(This, llvm::ConstantPointerNull::get(llvm::cast<llvm::PointerType>(This->getType())), "dtor.this.isnull");
    Builder.CreateCondBr(IsThisNull, ReturnBlock.getBlock(), ThisNotNull);
    
    EmitBlock(ThisNotNull);
  }
