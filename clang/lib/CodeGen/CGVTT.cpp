...
GetAddrOfVTTVTable(CodeGenVTables &CGVT, CodeGenModule &CGM,
  ...
  if (VTable.getBase() == MostDerivedClass) {
    ...
    return CGM.getCXXABI().getAddrOfVTable(MostDerivedClass, CGM.getContext().getASTRecordLayout(MostDerivedClass).getVtableFieldOffset(CGM.getContext(), MostDerivedClass));
  }
