...
echo used for the releases at https://github.com/Zenith-Team/RedHills/releases
echo.
...
if "%skip-checkout%" == "true" (
  ...
  curl -L https://github.com/Zenith-Team/RedHills/archive/%revision%.zip -o src.zip || exit /b 1
